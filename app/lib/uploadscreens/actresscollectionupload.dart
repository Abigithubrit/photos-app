...
class ActressCollectionUploadScreen extends StatefulWidget {
  final ActorModel? model;
  ActressCollectionUploadScreen({this.model});
  @override
  State<ActressCollectionUploadScreen> createState() => _ActressCollectionUploadScreenState();
}

class _ActressCollectionUploadScreenState extends State<ActressCollectionUploadScreen> {
  ...
  defaultScreen(){
    ...
    return Scaffold(
       appBar: AppBar(
        ...
        title: const Text('Add New actress',
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
               ...
               child: const Text('Add New actress',style: TextStyle(
...
if (imageXFile !=null)
{
 ...
 saveInfo(String downloadUrl) {
    final ref = FirebaseFirestore.instance
        ...
        .collection("actress").doc(widget.model!.menuID)
        .collection('item');
