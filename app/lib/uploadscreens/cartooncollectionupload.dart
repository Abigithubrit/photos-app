...
class CartoonCollectionUploadScreen extends StatefulWidget {
  final ActorModel? model;
  CartoonCollectionUploadScreen({this.model});
  @override
  State<CartoonCollectionUploadScreen> createState() => _CartoonCollectionUploadScreenState();
}

class _CartoonCollectionUploadScreenState extends State<CartoonCollectionUploadScreen> {
  ...
  itemUploadFormScreen(){
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Uploading New cartoon',
...
if (imageXFile !=null)
{
 ...
 saveInfo(String downloadUrl) {
    final ref = FirebaseFirestore.instance
        ...
        .collection("cartoon").doc(widget.model!.menuID)
    ...
    ref.doc(uniqueIdName).set({
      ...
      "thumbnailUrl": downloadUrl,
       ...
       final itemsRef = FirebaseFirestore.instance.collection("collection");
